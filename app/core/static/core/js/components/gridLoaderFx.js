...
var grids = [].slice.call(document.querySelectorAll('.grid')); var masonry = [];
var currentGrid = 0;
// Switch grid radio buttons.
var switchGridCtrls = [].slice.call(document.querySelectorAll('.control__radio'));
// Choose effect buttons.
var fxCtrls = [].slice.call(document.querySelectorAll('.control--effects > .control__btn'));
